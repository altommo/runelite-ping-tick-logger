...
public class PingLoggerPlugin extends Plugin
{
    ...
    private static final String PRAYER_FILE_PATH = System.getProperty("user.home") + "/.runelite/active_prayers.txt";
    ...
    @Inject
    private MouseCoordsOverlay mouseCoordsOverlay;
    ...
    protected void startUp() throws Exception
    {
        ...
        log.info("Output files: ping={}, tick={}, data={}, prayer={}", PING_FILE_PATH, TICK_FILE_PATH, DATA_FILE_PATH, PRAYER_FILE_PATH);
        ...
        writeToFile(PRAYER_FILE_PATH, "");

        overlayManager.add(mouseCoordsOverlay);
    ...
    protected void shutDown() throws Exception
    {
        ...
        worlds = null;
        tickLengths.clear();
        overlayManager.remove(mouseCoordsOverlay);
    ...
    public void onGameTick(GameTick tick)
    {
        ...
        // Write active prayers to file if enabled
        if (config.writeActivePrayers())
        {
            updateActivePrayersFile();
        }
    ...
    private void updateActivePrayersFile()
    {
        ...
        for (Prayer prayer : Prayer.values())
        {
            ...
            {
                sb.append(prayer.name()).append("\n");
            }
        }
        writeToFile(PRAYER_FILE_PATH, sb.toString());
    }
    ...
    public Rectangle getRectangle()
    {
        ...
        return new Rectangle(rectStart.x, rectStart.y, rectEnd.x - rectStart.x, rectEnd.y - rectStart.y);
    }
