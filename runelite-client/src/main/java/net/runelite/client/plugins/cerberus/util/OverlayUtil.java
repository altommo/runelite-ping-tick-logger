...
public class OverlayUtil
{
	...
	{
		// Use the first prayer widget as a fallback since individual prayer widgets are available
		Widget widget = client.getWidget(InterfaceID.Prayerbook.PRAYER1);

		if (widget == null || client.getVar(VarClientInt.INVENTORY_TAB) != 5)
		{
			return null;
		}
