...
public abstract class TheatrePrayerOverlay extends Overlay
{
	...
	/**
	 * Get the widget for a specific prayer
	 */
	private Widget getPrayerWidget(net.runelite.api.Prayer prayer)
	{
		// Map prayers to their widget IDs based on their position in the prayer book
		switch (prayer)
		{
			case PROTECT_FROM_MELEE:
				return client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER18); // Protect from Melee
			case PROTECT_FROM_MISSILES:
				return client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER17); // Protect from Missiles
			case PROTECT_FROM_MAGIC:
				return client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER16); // Protect from Magic
			default:
				return null;
		}
	}
	...
	{
		final Widget meleePrayerWidget = client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER3);
		final Widget rangePrayerWidget = client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER4);
		final Widget magicPrayerWidget = client.getWidget(net.runelite.api.gameval.InterfaceID.Prayerbook.PRAYER5);
